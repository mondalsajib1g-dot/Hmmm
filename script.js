document.addEventListener('DOMContentLoaded', () => {
    ...
    function createParticle(type) {
        ...
        particle.innerHTML = type === 'petal' ? (Math.random() > 0.5 ? '🌸' : '🌹') : '💖';
        ...
        rose.addEventListener('click', () => {
            ...
            if (index === correctRoseIndex) {
                ...
                setTimeout(() => {
                    ...
                    catGif.src = "https://media.tenor.com/Jszm_S-2964AAAAM/happy-cat-jumping-happy-cat.gif";
                ...
                setTimeout(() => {
                    puzzleResult.classList.remove('hidden');
                    catGif.src = "https://media.tenor.com/0v56M73p_nAAAAAM/cat-sad.gif";
    ...
    btn3.addEventListener('click', () => {
        ...
        letterContent.innerHTML = `
            ...
            <p style="font-size: 1.2rem; margin: 15px 0; color: #ff1e7c; font-weight: 600;">
                Happy Rose Day with ${crushName} 🌹
            </p>
            <p>Just like this rose, my feelings for you are simple, soft, and real.</p>
            <p>Your smile makes my ordinary days special, and I wanted to give you something sweet to remember this day.</p>
            <p style="font-size: 1.1rem; font-weight: 500;">Always stay the same 💖</p>
            <div style="margin-top: 30px; border-top: 1px dashed var(--primary-pink); padding-top: 15px;">
                ...
                <p style="font-family: 'Pacifico', cursive; color: var(--deep-pink); margin: 0;">Wishes by Soham</p>
            </div>
        `;
    });
